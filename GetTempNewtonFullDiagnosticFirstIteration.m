function [GuessTc,I2R,I2Rprime,Prad,PradPrime,PradPrimePrime,Pcon,PconPrime,PconPrimePrime] =GetTempNewtonFullDiagnosticFirstIteration(I,Ta,H,D,phi,Vw,R_T_high,R_T_low, T_high, T_low,epsilons,Psol,GuessTc)
    phi=90*pi/180;
