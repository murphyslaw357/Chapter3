function [GuessTc,I2R,I2Rprime,Prad,Pradprime,Pcon,Pconprime] =GetTempNewtonFirstIteration(I,Ta,H,D,phi,Vw,R_T_high,R_T_low, T_high, T_low,epsilons,Psol)
    ...
    if(I2Rprime-Pradprime-Pconprime>0)
        disp('doh')
    end
