...
for c1=1:numWorkers:weatherPermutationCount
    ...
    parfor c=c1:c1+increment
        ...
        for counter=1:weatherPermutationCount
            ...
            [roott,Pj,~,~,~,~,~,convergenceOrder] = GetTempNewton(currents(counter)*maxcurrent,ambtemps(counter),H,diam,phi,winds(counter),alpha,beta,epsilons,psols(counter),f,ff,ffinv,polymodel);
